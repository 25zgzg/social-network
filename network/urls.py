...
urlpatterns=[
 ...
 path('posts/<int:pk>/like/',views.toggle_like,name='like'),path('posts/<int:pk>/comment/',views.add_comment,name='comment'),path('posts/<int:pk>/share/',views.share_post,name='share'),path('posts/<int:pk>/rate/',views.rate_post,name='rate_post'),
 ...
 path('notifications/',views.notifications,name='notifications'),path('notifications/settings/',views.notification_settings,name='notification_settings'),path('chats/',views.chats,name='chats'),path('chats/new/',views.conversation_create,name='conversation_create'),path('chats/with/<str:username>/',views.start_chat,name='start_chat'),path('search/',views.search,name='search'),path('theme/set/',views.set_theme,name='set_theme'),path('settings/',views.settings_page,name='settings'),path('check-username/',views.check_username,name='check_username'),path('chats/<int:pk>/',views.conversation,name='conversation'),path('chats/<int:pk>/upload/',views.chat_upload,name='chat_upload')
]
